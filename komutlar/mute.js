...
module.exports.run = async (bot, message, args) => {
    ...
    let muteliroluu = await db.fetch(`gagrol_${message.guild.id}`) 
    ...
    if(moderasyonrol){
        if (!message.member.roles.has(moderasyonrol.id) || !message.member.hasPermission("MUTE_MEMBERS")){
              message.delete()
...
exports.conf = {
    ...
    aliases: ['sustur'],
    kategori: "moderasyon",
    permLevel: "Üyeleri Sustur veya Moderasyon Rol"
  };
